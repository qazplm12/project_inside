...
//        SpringApplication.run(ProjectInsideApplication.class, args).getBean(ProjectInsideApplication.class).test();   // 서버 동작 시 즉시 셀레니움 실행
        SpringApplication.run(ProjectInsideApplication.class, args);
    }
