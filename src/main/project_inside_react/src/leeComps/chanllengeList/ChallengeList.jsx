...
function ChallengeList(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:8081/server/challengeList?userNick=${userInfo?.personNickName}&challengeClass=${challengeClass}&solvedState=${solvedState}`)    // ChallengeListTableTd에도 로그인 정보 넣기(아마 루터에서 넣어줘야 할듯?)
            .then(res => {
